...
- **[Node.js 18](https://nodejs.org/) or later:** We use Node.js to send requests to the Rime API.

### Create your script

Create a file called `rime_hello_world.js` and import the required library modules:
