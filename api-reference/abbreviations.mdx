...
By default, Rime will pronounce series of capital letters as acronyms, in other words, it will prounouce them as single words. However, for many common initialisms, such as DNA, ID, USA, FBI, and CIA, Rime will automatically pronounce them correctly as a series of letters.
