...
If you'd like to experiment with Rime's TTS API directly before building a full voice agent, check out: [generate text-to-speech in under five minutes](/docs/quickstart-five-minute).
