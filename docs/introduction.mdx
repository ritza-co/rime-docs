...
Ready to get started with Rime? Follow the [Python quickstart](/docs/quickstart-five-minute) to begin generating text-to-speech with Rime's proprietary models in under five minutes.
