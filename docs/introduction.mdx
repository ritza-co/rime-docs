...
Rime provides text-to-speech AI models built specifically for real-time conversation. The latest [Arcana v3](https://rime.ai/resources/arcana-v3) model delivers sub-120ms on-prem latency and sub-200ms latency via cloud API. This is fast enough for mid-utterance control and barge-in with no awkward silences.
...
- **Mist v2** prioritizes speed and control, delivering accurate pronunciation with fine-grained customization options for high-volume applications.
