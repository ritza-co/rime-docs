...
- **A Rime API token:** Create a free [Rime account](https://app.rime.ai/tokens/) and copy your API key from the [API Tokens](https://app.rime.ai/tokens/) page.
...
If you're strapped for time and just want to hear a Rime voice, skip to the [Full script](#full-script) section. Otherwise, continue step-by-step to create the API call.
...
The [Arcana API reference](/api-reference/arcana/streaming-mp3) and the [Mist V2 API reference] have details about the many optional parameters you can add to request payloads.
...
Create a file called `rime_hello_world.py` or `rime_hello_world.js`, then copy and paste the full script into that file:
...
<CardGroup cols={2}>
  <Card title="Models" icon="microchip" href="/docs/models">
    Compare Arcana (realistic) and Mist V2 (fast)
  </Card>
